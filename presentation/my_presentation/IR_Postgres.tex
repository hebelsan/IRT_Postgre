...
\frametitle{Objectives}
	...
	\begin{itemize}
		\item How does an IRS look made of a relational database
	...
	\begin{block}{\centering}
		Support search querys with the boolean operator AND
	\end{block}
} % END OF FRAME
...
\frame{
	...
	\begin{itemize}
		\item[-] count number of \textbf{all} lexemes in a tsvector
...
\begin{itemize}
	...
	\item User wants the most relevant section and not the "best" document
	\item So how is the relationship between page and section ranking
\end{itemize}

\begin{block}{\centering Calculation of Ranking}
	\begin{itemize}
		\item \textbf{section}: ranking / num\_words\_of\_section
		\item \textbf{page}: sum\_of\_rankings / num\_words\_of\_page
	\end{itemize}
\end{block}
